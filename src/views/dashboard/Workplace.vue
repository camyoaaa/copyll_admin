...
export default {
    ...
    methods: {
        getProjects() {
            this.$kaxios.get('/list/search/projects').then(res => {
                this.projects = res.result && res.result.data
                this.loading = false
            })
        },
        getActivity() {
            this.$kaxios.get('/workplace/activity').then(res => {
                this.activities = res.result
            })
        },
        getTeams() {
            this.$kaxios.get('/workplace/teams').then(res => {
        ...
        initRadar() {
            ...
            this.$kaxios.get('/workplace/radar').then(res => {
